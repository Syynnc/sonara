  ...
  return (
    <div className="min-h-[100dvh] bg-[#121212] pt-28 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-xs font-semibold tracking-[0.25em] text-[#1DB954]/50 uppercase mb-2">
            {getGreeting()}
          </p>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-[#FFFFFF]">
            Hey, {firstName}.
          </h1>
          <p className="text-[#B3B3B3]/55 mt-2 text-sm">Here&apos;s what you&apos;ve been listening to.</p>
        </div>

        {spotifyError && (
          <div className="mb-10 px-5 py-4 bg-[#1DB954]/8 border border-[#1DB954]/20 rounded-2xl flex items-center justify-between gap-4">
            <p className="text-sm text-[#B3B3B3]">
              Your Spotify session expired. Sign in again to refresh your data.
            </p>
            <a
              href="/login?error=token_expired"
              className="shrink-0 px-4 py-2 text-xs font-semibold text-[#121212] bg-[#1DB954] rounded-full hover:bg-[#1ed760] transition-colors"
            >
              Reconnect
            </a>
          </div>
        ...
        {topTracks.length > 0 && (
          ...
          >
            <div className="flex items-center gap-4 mb-5">
              ...
              <span className="text-[10px] text-[#B3B3B3]/30">Last 4 weeks</span>
            </div>
        ...
        {topArtists.length > 0 && (
          ...
          >
            <div className="flex items-center gap-4 mb-5">
              ...
              <div className="flex-1 h-px bg-[#282828]" />
              <span className="text-[10px] text-[#B3B3B3]/30">Last 6 months</span>
            </div>
        ...
        {!spotifyError && topTracks.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-16 h-16 rounded-full bg-[#181818] border border-[#282828] flex items-center justify-center mb-5">
              <span className="text-2xl text-[#B3B3B3]/30 font-mono">♪</span>
            </div>
            <h3 className="text-lg font-semibold text-[#FFFFFF]/60 mb-2">No listening history yet</h3>
            <p className="text-sm text-[#B3B3B3]/35 max-w-[32ch]">
